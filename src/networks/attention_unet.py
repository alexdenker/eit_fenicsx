...
class FCAttentionUNetModel(nn.Module):
    """
    The full UNet model with attention and timestep embedding.
    :param in_channels: channels in the input Tensor.
    :param model_channels: base channel count for the model.
    ...
    def __init__(
        ...
        self.initial_linear.bias.data.fill_(1.0)
    ...
    def linear_layer(self, x):
        ...
        return nn.functional.interpolate(x_img, (self.image_size, self.image_size), mode="bilinear")
...
if __name__ == "__main__":
    ...
    model = AttentionUNetModel(
        ...
        out_channels=1,
        num_res_blocks=2,
        channel_mult=(1, 2, 2, 4, 4), # 256 - 128 - 64 - 32 - 16
